...
var $author$project$Exercises$AccountConfiguration = F3(
	function (preferredTheme, subscribedToNewsletter, twoFactorAuthOn) {
		return {preferredTheme: preferredTheme, subscribedToNewsletter: subscribedToNewsletter, twoFactorAuthOn: twoFactorAuthOn};
	});
var $author$project$Theme$Dark = {$: 'Dark'};
var $author$project$Theme$Light = {$: 'Light'};
var $author$project$Lists$map = F2(
	function (fn, l) {
		if (!l.b) {
			return _List_Nil;
		} else {
			...
			return A2(
				$elm$core$List$cons,
				fn(x),
				A2($author$project$Lists$map, fn, xs));
		}
	});
var $author$project$L05$changePreferenceToDarkTheme = function (accounts) {
	return A2(
		$author$project$Lists$map,
		function (x) {
			return _Utils_update(
				x,
				{preferredTheme: $author$project$Theme$Dark});
		},
		accounts);
};
var $author$project$L05$reverse = function (l) {
	var reverseAcc = F2(
		function (lx, acc) {
			reverseAcc:
			while (true) {
	...
	return A2(reverseAcc, l, _List_Nil);
};
var $author$project$L05$chunks = F2(
	function (size, list) {
		var helper = F4(
			function (n, l, acc, _return) {
				helper:
				while (true) {
					if (!l.b) {
						return _return;
						...
						if (!n) {
							var $temp$n = size - 1,
								...
								[x]),
								$temp$return = A2($elm$core$List$cons, acc, _return);
							n = $temp$n;
							l = $temp$l;
							acc = $temp$acc;
							_return = $temp$return;
							...
							var $temp$n = n - 1,
								$temp$l = xs,
								$temp$acc = $author$project$L05$reverse(
		...
		return $author$project$L05$reverse(
			A4(helper, size, list, _List_Nil, _List_Nil));
	});
var $author$project$Lists$foldl = F3(
	function (op, start, l) {
		foldl:
		while (true) {
			if (!l.b) {
...
var $author$project$L05$countVowels = function (s) {
	var isVowel = function (vow) {
		return _Utils_eq(
			...
			vow,
			_Utils_chr('i')) || (_Utils_eq(
			vow,
			_Utils_chr('o')) || (_Utils_eq(
			vow,
			_Utils_chr('u')) || (_Utils_eq(
			vow,
			_Utils_chr('A')) || (_Utils_eq(
			vow,
			_Utils_chr('E')) || (_Utils_eq(
...
var $author$project$Exercises$User = F3(
	function (id, email, details) {
		return {details: details, email: email, id: id};
	});
var $author$project$Exercises$UserDetails = F3(
	function (firstName, lastName, phoneNumber) {
		return {firstName: firstName, lastName: lastName, phoneNumber: phoneNumber};
	});
var $author$project$Exercises$makeUser = F5(
	function (id, email, firstName, lastName, phoneNumber) {
		return A3(
			$author$project$Exercises$User,
			id,
			email,
			A3($author$project$Exercises$UserDetails, firstName, lastName, phoneNumber));
	});
...
var $author$project$Lists$filter = F2(
	function (pred, l) {
		filter:
		while (true) {
			if (!l.b) {
				...
				if (pred(x)) {
					return A2(
						$elm$core$List$cons,
						x,
						A2($author$project$Lists$filter, pred, xs));
				} else {
					var $temp$pred = pred,
						$temp$l = xs;
					pred = $temp$pred;
...
var $author$project$L05$usersWithPhoneNumbers = function (users) {
	return A2(
		$author$project$Lists$map,
		function (x) {
			var _v1 = x.details.phoneNumber;
			if (_v1.$ === 'Just') {
				var res = _v1.a;
				return res;
			} else {
		...
		A2(
			$author$project$Lists$filter,
			function (x) {
				var _v0 = x.details.phoneNumber;
				if (_v0.$ === 'Just') {
					return true;
				} else {
					return false;
...
var $author$project$TestSuite$suite = A2(
	...
	_List_fromArray(
		[
				...
				[
					...
					function (_v0) {
						return A2(
							...
							4,
							$author$project$L05$countVowels('Tiberiu'));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'Test Two',
					function (_v1) {
						return A2(
							$elm_explorations$test$Expect$equal,
							0,
							$author$project$L05$countVowels('BCdgthlMnq'));
					})
				])),
			A2(
			$elm_explorations$test$Test$describe,
			'Exercises.usersWithPhoneNumbers',
			_List_fromArray(
				[
					A2(
					$elm_explorations$test$Test$test,
					...
					function (_v2) {
						var user3 = A5(
							$author$project$Exercises$makeUser,
							'jacob14',
							'jacobh@yahoo.com',
							'Jacob',
							'Hunt',
							$elm$core$Maybe$Just('345870481'));
						var user2 = A5($author$project$Exercises$makeUser, 'jane12', 'jane12@yahoo.com', 'Jane', 'Doe', $elm$core$Maybe$Nothing);
						var user1 = A5(
							$author$project$Exercises$makeUser,
							'john00',
							'johndoe@gmail.com',
							'John',
							'Doe',
							$elm$core$Maybe$Just('0123456789'));
						return A2(
							$elm_explorations$test$Expect$equal,
							_List_fromArray(
								[user1.email, user3.email]),
							$author$project$L05$usersWithPhoneNumbers(
								_List_fromArray(
									[user1, user2, user3])));
					}),
					A2(
					...
					'My Test - Empty',
					function (_v3) {
						var user3 = A5($author$project$Exercises$makeUser, 'jacob14', 'jacobh@yahoo.com', 'Jacob', 'Hunt', $elm$core$Maybe$Nothing);
						var user2 = A5($author$project$Exercises$makeUser, 'jane12', 'jane12@yahoo.com', 'Jane', 'Doe', $elm$core$Maybe$Nothing);
						var user1 = A5($author$project$Exercises$makeUser, 'john00', 'johndoe@gmail.com', 'John', 'Doe', $elm$core$Maybe$Nothing);
						return A2(
							$elm_explorations$test$Expect$equal,
							_List_Nil,
							$author$project$L05$usersWithPhoneNumbers(
			...
			A2(
			$elm_explorations$test$Test$describe,
			'Exercises.changePreferenceToDarkTheme',
			_List_fromArray(
				[
					A2(
					$elm_explorations$test$Test$test,
					'First example',
					function (_v4) {
						var config3 = A3($author$project$Exercises$AccountConfiguration, $author$project$Theme$Dark, false, true);
						var config2 = A3($author$project$Exercises$AccountConfiguration, $author$project$Theme$Dark, false, false);
						var config1Dark = A3($author$project$Exercises$AccountConfiguration, $author$project$Theme$Dark, true, false);
						var config1 = A3($author$project$Exercises$AccountConfiguration, $author$project$Theme$Light, true, false);
						return A2(
							$elm_explorations$test$Expect$equal,
							_List_fromArray(
								[config1Dark, config2, config3]),
							$author$project$L05$changePreferenceToDarkTheme(
								_List_fromArray(
					...
					function (_v5) {
						var config3 = A3($author$project$Exercises$AccountConfiguration, $author$project$Theme$Dark, false, true);
						var config2 = A3($author$project$Exercises$AccountConfiguration, $author$project$Theme$Dark, false, false);
						var config1 = A3($author$project$Exercises$AccountConfiguration, $author$project$Theme$Dark, true, false);
						return A2(
							$elm_explorations$test$Expect$equal,
							_List_fromArray(
								[config1, config2, config3]),
				...
				[
					...
					function (_v8) {
						return A2(
							$elm_explorations$test$Expect$equal,
							_List_Nil,
							A2($author$project$L05$chunks, 4, _List_Nil));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'My Test 1',
