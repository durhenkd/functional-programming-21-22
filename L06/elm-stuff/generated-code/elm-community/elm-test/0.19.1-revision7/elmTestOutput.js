...
var $author$project$L06$unravelInHtml = F4(
	function (list, tag, attrBuilder, htmlBuilder) {
		var tailHelper = F5(
			function (l, t, at, ht, acc) {
				tailHelper:
				while (true) {
					if (!l.b) {
						return acc;
		...
		return A5(tailHelper, list, tag, attrBuilder, htmlBuilder, _List_Nil);
	});
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_Nil,
				A4(
					$author$project$L06$unravelInHtml,
					recipe.ingredients,
					$elm$html$Html$li,
					function (_v0) {
						return _List_fromArray(
...
var $author$project$CounterClass$view = function (model) {
	var textStyle = ((model >= 8) || (_Utils_cmp(model, -8) < 1)) ? _List_fromArray(
		[
	...
	var incDisabled = (model >= 10) ? true : false;
	var decDisabled = (_Utils_cmp(model, -10) < 1) ? true : false;
			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$Attributes$disabled(incDisabled)
					]),
				_List_fromArray(
					[
						$elm$html$Html$text('+')
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$Attributes$disabled(decDisabled)
					]),
				_List_fromArray(
					[
						$elm$html$Html$text('-')
...
var $author$project$Test$Generated$Main$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		...
		paths: _List_fromArray(
			['/home/durhenkd/Documents/UTCN/An III CTI en - le me/FP - R. R. Slavescu/functional-programming-21-22/L06/tests/CoinFlipTests.elm', '/home/durhenkd/Documents/UTCN/An III CTI en - le me/FP - R. R. Slavescu/functional-programming-21-22/L06/tests/CounterTests.elm', '/home/durhenkd/Documents/UTCN/An III CTI en - le me/FP - R. R. Slavescu/functional-programming-21-22/L06/tests/RecipeTests.elm']),
		processes: 16,
...
var pipeFilename = "/tmp/elm_test-15532.sock";
var net = require('net'),
